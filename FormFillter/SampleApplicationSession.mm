...
- (void)initVuforiaInBackground
{
    ...
    @autoreleasepool {
        Vuforia::setInitParameters(mVuforiaInitFlags,"");
...
-(void) showCameraAccessWarning
{
    ...
    UIAlertController *alert = [UIAlertController alertControllerWithTitle:@"Camera Access Warning"
                                                                   message:message
